# -*- coding: utf-8 -*-
"""
Created on Wed Jul 10 09:38:50 2019
...
FWHM    = 28.4  # pulse duration (ps)
pulseWL = 835   # pulse central wavelength (nm)

GDD     = 0.0    # Group delay dispersion (ps^2)
TOD     = 0.0    # Third order dispersion (ps^3)
pump_power = 1.0e1 # Peak power

Window  = 1000   # simulation window (ps)
...
fiber1.generate_fiber(Length * 1e-3, center_wl_nm=fibWL, betas=betas,
                              gamma_W_m=Gamma * 1e-3, gvd_units='ps^n/km', gain=1,label='gainfiber',Esat=2e-9)
